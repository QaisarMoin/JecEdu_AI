  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 lg:ml-64 pt-16 lg:pt-0 w-full max-w-full overflow-x-hidden">
        ...
        <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 px-4 md:px-8 pt-8 pb-20">
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 -mt-12">
          {/* Stats Cards */}
          {notices.length > 0 && (
            <div className="flex overflow-x-auto w-full gap-3 mb-6 pb-2 sm:pb-0 sm:grid sm:grid-cols-3 sm:gap-4 scrollbar-hide">
              <button
                onClick={() =>
                  setFilterPriority(
                ...
                className={`flex-shrink-0 w-[140px] sm:w-auto bg-white rounded-xl p-3 sm:p-4 shadow-sm border transition-all duration-200 hover:shadow-md group ${
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div>
                    <p className="text-[10px] sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Normal</p>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-0.5">
                      {normalCount}
                    </p>
                  </div>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-50 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div>
                    <p className="text-[10px] sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                      Important
                    </p>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-0.5">
                      {importantCount}
                  ...
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-50 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div>
                    <p className="text-[10px] sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Urgent</p>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-0.5">
                      {urgentCount}
                    </p>
                  </div>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-50 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
          ...
          {notices.length > 0 && (
            <div className="flex flex-col gap-3 mb-6">
              <div className="flex items-center justify-between gap-3">
                <div className={`relative flex-1 transition-all duration-300 ${isSearchOpen ? 'translate-y-0 opacity-100' : 'hidden sm:block'}`}>
                ...
                <div className="flex items-center gap-2 ml-auto">
                  ...
                  <button 
                    ...
                    className="sm:hidden p-2.5 bg-white border border-gray-200 rounded-xl text-gray-500 shadow-sm"
                  >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-3 flex-1 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p
                              className={`mt-2 text-sm text-gray-600 leading-relaxed break-words ${
                      ...
                      {/* Footer */}
                      <div className="mt-4 pt-3 border-t border-gray-50 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
